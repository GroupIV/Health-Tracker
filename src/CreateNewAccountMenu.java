public class CreateNewAccountMenu
{
	...
	public void submit()
	{
		...
		DoctorInfo DI = new DoctorInfo(doctorFirstName, doctorLastName, doctorAddress, doctorEmail, doctorPhoneNumber);
		...
		UserAccount account = new UserAccount(userFirstName, userLastName, userAge, userGender, DI);
